...
jobs:
  example-main:
    ...
    steps:
      ...
      - name: Create release
        uses: danielemery/github-release-actions/create-prerelease@v0.1.0
        with:
  ...
  example-prepare-production-deployment:
    ...
    steps:
      - name: Perform pre-release actions
        uses: danielemery/github-release-actions/perform-pre-release@v0.1.0
        id: pre_release
        with:
          github-token: ${{ secrets.GITHUB_TOKEN }}
  ...
  example-deploy-production:
    ...
    steps:
      ...
      - name: Perform post-release actions
        uses: danielemery/github-release-actions/perform-post-release@v0.1.0
        with:
          github-token: ${{ secrets.GITHUB_TOKEN }}
